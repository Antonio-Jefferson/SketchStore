...
<body>
  <div class="w-full">
    <header class="flex justify-between items-center pl-8 pr-8 w-full h-32 bg-primary mb-8">
      <h1 class="text-4xl font-bold text-gray-50">SketchStore</h1> 
      <div class="flex items-center gap-6">
        <div class="flex w-16 h-10 bg-white rounded-md items-center  justify-evenly">
      ...
      <div class="flex items-center gap-10">
        <p class="text-lg text-slate-50">Faça LOGIN ou <br> CADASTRE-SE</p>
